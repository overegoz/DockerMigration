...
class Profile:
	...
	l_check_bit = {1:FLOAT_ANY,
					...
					2213: 30 * MB,
					2222: 30 * MB,
					2223: 30 * MB}  # 체크 포인트 만들어서 크기 확인하고 입력하기
	# -------------------------------------------------------------------
	# log 파일 크기  (bit)
	l_log_bit = {1:FLOAT_ANY,
				...
				2213: 1 * MB,
				2222: 1 * MB,
				2223: 1 * MB} # 어차피 log 파일은 크기가 작으니까 1MB이라고 하자
	# -------------------------------------------------------------------
	...
	img_name_ap1 = {1:  'twoon/profile1:es1',
					...
					2212: 'twoon/profile2212:es1',
					2213: 'twoon/profile2213:es1',
					2222: 'twoon/profile2222:es1',
					2223: 'twoon/profile2223:es1'}
	# -------------------------------------------------------------------
	...
	img_name_ap2 = {1:  'twoon/profile1:es2',
					...
					2212: 'twoon/profile2212:es2',
					2213: 'twoon/profile2213:es2',
					2222: 'twoon/profile2222:es2',
					2223: 'twoon/profile2223:es2'}
	# -------------------------------------------------------------------
	...
	checkpoint_name = {1:'none',
						...
						2212: 'profile2212checkpoint',
						2213: 'profile2213checkpoint',
						2222: 'profile2222checkpoint',
						2223: 'profile2223checkpoint'}
